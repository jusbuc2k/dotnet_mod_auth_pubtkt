...
namespace Website.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> LogOff()
        {
            ...
            await this.HttpContext.Authentication.SignOutAsync(ModAuthPubTktAuthenticationOptions.DefaultAuthenticationScheme);
        ...
        public async Task<IActionResult> VerifyCode(VerifyCodeViewModel model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                await this.HttpContext.Authentication.SignInAsync(ModAuthPubTktAuthenticationOptions.DefaultAuthenticationScheme, principal);
